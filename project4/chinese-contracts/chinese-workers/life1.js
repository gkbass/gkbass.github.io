var regions = {
    ...
    x = d3.scale.linear().domain([2009, 2018]).range([0 + margin - 5, w]),
...
d3.text('country-regions1.csv', 'text/csv', function (text) {
...
var startEnd = {},
    countryCodes = {};
d3.text('life-expectancy-cleaned-all1.csv', 'text/csv', function (text) {
...
function onmouseover(d, i) {
    ...
    blurb += "<p>There were " + Math.round(countryVals['startVal']) + " Chinese workers in " + countryVals['startYear'] + " and " + Math.round(countryVals['endVal']) + " Chinese workers in " + countryVals['endYear'] + ", ";
