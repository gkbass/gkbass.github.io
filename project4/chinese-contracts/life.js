var regions = { "MEA": "Middle East & North Africa", "SSF": "Sub-Saharan Africa"},
//var regions = { "SAS": "South Asia" , "ECS": "Europe and Central Asia", "MEA": "Middle East & North Africa", "SSF": "Sub-Saharan Africa", "LCN": "Latin America & Caribbean", "EAS": "East Asia &amp; Pacific", "NAC": "North America" },
	...
	x = d3.scale.linear().domain([1998, 2017]).range([0 + margin -5, w]),
...
function onmouseover(d, i) {
    ...
    blurb += "<p> " + Math.round(countryVals['startVal']) + " million US Dollars in " + countryVals['startYear'] + " and " + Math.round(countryVals['endVal']) + " million US Dollars in " + countryVals['endYear'] + ", ";
    if (percentChange >= 0) {
